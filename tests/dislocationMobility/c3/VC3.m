...
a = readtable('T_C3LT.txt');
b = readtable('T_C3HT.txt');
c = readtable('C_C3LT.txt');
d = readtable('C_C3HT.txt');
...
subtitle('Loading Orientation: [-5/6 5/6 1]','FontSize',12)
grid on

%% Screw Stress vs. Velocity
at = table2array(readtable('T_C3S_Screw.txt'));
ac = table2array(readtable('C_C3S_Screw.txt'));
...
subtitle('Loading Orientation: [-5/6 5/6 1] | Misorientation Angle: 0^{o}','FontSize',12)

%% Screw Temp vs. Velocity
a = table2array(readtable('C_C3T_Screw.txt'));
b = table2array(readtable('T_C3T_Screw.txt'));
...
at = table2array(readtable('T_C3S_Edge.txt'));
ac = table2array(readtable('C_C3S_Edge.txt'));
...
subtitle('Loading Orientation: [-5/6 5/6 1] | Misorientation Angle: 90^{o}','FontSize',12)

%% Edge Temp vs. Velocity
a = table2array(readtable('C_C3T_Edge.txt'));
b = table2array(readtable('T_C3T_Edge.txt'));
