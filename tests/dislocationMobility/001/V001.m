...
a = readtable('T001LT.txt');
b = readtable('T001HT.txt');
c = readtable('C001LT.txt');
d = readtable('C001HT.txt');
...
at = table2array(readtable('T001S_Screw.txt'));
ac = table2array(readtable('C001S_Screw.txt'));
...
subtitle('Loading Orientation: [001] | Misorientation Angle: 0^{o}','FontSize',12)
xlim([0 max(sc)])
ylim([0 max(vc2)])

%% Screw Temp vs Velocity
a = table2array(readtable('C001T_Screw.txt'));
b = table2array(readtable('T001T_Screw.txt'));
...
at = table2array(readtable('T001S_Edge.txt'));
ac = table2array(readtable('C001S_Edge.txt'));
...
subtitle('Loading Orientation: [001] | Misorientation Angle: 90^{o}','FontSize',12)
xlim([0 max(sc)])
ylim([0 max(vc2)])

%% Edge Temp vs. Velocity
a = table2array(readtable('C001T_Edge.txt'));
b = table2array(readtable('T001T_Edge.txt'));
...
inset_pos = [0.65 0.63 0.25 0.25];  % Top-right corner
ax_inset = axes('Position', inset_pos);
img = imread('001.png');  % Replace with your image file
imshow(img, 'Parent', ax_inset);
axis(ax_inset, 'off');