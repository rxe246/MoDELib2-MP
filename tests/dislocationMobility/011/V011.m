...
a = readtable('T011LT.txt');
b = readtable('T011HT.txt');
c = readtable('C011LT.txt');
d = readtable('C011HT.txt');
...
subtitle('Loading Orientation: [011]','FontSize',12)
grid on

%% Screw Stress vs. Velocity
at = table2array(readtable('T011S_Screw.txt'));
ac = table2array(readtable('C011S_Screw.txt'));
...
subtitle('Loading Orientation: [011] | Misorientation Angle: 0^{o}','FontSize',12)
xlim([0 4.5])

%% Screw Temperature vs. Velocity
a = table2array(readtable('C011T_Screw.txt'));
b = table2array(readtable('T011T_Screw.txt'));
...
at = table2array(readtable('T011S_Edge.txt'));
ac = table2array(readtable('C011S_Edge.txt'));
...
subtitle('Loading Orientation: [011] | Misorientation Angle: 90^{o}','FontSize',12)

%% Edge Temperature vs. Velocity
a = table2array(readtable('C011T_Edge.txt'));
b = table2array(readtable('T011T_Edge.txt'));
