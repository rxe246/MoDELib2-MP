...
//                const auto& fieldLink(*fieldLinkIter);
                ...
                if(   !fieldLink.second.lock()->hasZeroBurgers()
                   ...
                   && !(fieldLink.second.lock()->source->isBoundaryNode() && fieldLink.second.lock()->sink->isBoundaryNode())
...
//                        }
                    ...
                    {// sum line-integral part of displacement field per segment
                        if(   !sourceLink.second.lock()->hasZeroBurgers()
                           ...
                           && !(sourceLink.second.lock()->source->isBoundaryNode() && sourceLink.second.lock()->sink->isBoundaryNode())
