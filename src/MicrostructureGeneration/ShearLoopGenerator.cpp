...
ShearLoopGenerator::ShearLoopGenerator(const ShearLoopDensitySpecification& spec,MicrostructureGenerator& mg)
{
    ...
    if(spec.targetDensity_SI>0.0)
    {
        ...
        std::normal_distribution<double> radiusDistribution(spec.radiusDistributionMean_SI/mg.ddBase.poly.b_SI,spec.radiusDistributionStd_SI/mg.ddBase.poly.b_SI);
        ...
        while(density<spec.targetDensity_SI)
        {
